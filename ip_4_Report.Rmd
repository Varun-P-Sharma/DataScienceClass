...
I also have added in the covariates Latitude and Longevity, which are pond-level covariates. 

```{r, eval = FALSE}
stan.fit2 <- stan_glmer(Echinostoma ~ visit + SpeciesCode + visitScaledSVL +scale(Latitude) + Longevity+ (SpeciesCode|SiteCode/fsample) , data = dis,  family =neg_binomial_2(link="log"))
