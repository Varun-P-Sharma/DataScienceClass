...
(2) $log(\mu_i)$ = $\alpha_{j[i]}$ + $\beta_1*visit$ + $\beta_2*species$ + $\beta_3*SVL$ + $\beta_4*visit*species$ + $\beta_5*visit*SVL$ + $\epsilon_i$
...
(3) $\epsilon_i$ ~ Normal(0, $\sigma^2_\epsilon$)
