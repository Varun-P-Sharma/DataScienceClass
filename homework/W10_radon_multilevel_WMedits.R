...
#' This is part I: EDA and variance components model (G&H 12.2). In part II we
#' consider house-level and county-level predictors.
#' 
...
summary(ppfit)
#' This shows that the variance at the houses-within county level (0.6) is about
#' 6 times greater than the variance at the between-county level (0.1). In other
#' words, most of the variance in radon is at a small spatial scale, i.e.
#' between houses. Keep in mind that the house-level variance includes radon
#' measurement error in addition to natural variability among houses.
#'
#' Plot the fitted model
...
#' than simply the overall mean of the data (solid blue line).
#' 
...
## RANDOM EFFECTS ARE ADDED TO THE LINEAR MODEL SO THEYRE FORMATTED AS DEVIATIONS
